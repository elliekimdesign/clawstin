...
/**
 * "mint_os" background art — the approved skyblue_os swoosh geometry recolored
 * to a bright mint-green field with a deep teal ribbon. A bright field
      ...
      <Svg width="100%" height="100%" viewBox="0 0 390 844" preserveAspectRatio="xMidYMid slice">
        <Defs>
          ...
          <LinearGradient id="base" x1="0" y1="0" x2="0.4" y2="1">
            <Stop offset="0%" stopColor="#79A8A3" />
            <Stop offset="55%" stopColor="#8CBBB2" />
            <Stop offset="100%" stopColor="#B7D8CB" />
          </LinearGradient>

          {/* dark ribbon: strongest in its heart, melting at both rims */}
          <LinearGradient id="darkBand" x1="0" y1="0" x2="0.5" y2="1">
            <Stop offset="0%" stopColor="#2F6560" stopOpacity={0.5} />
            <Stop offset="60%" stopColor="#2F6560" stopOpacity={0.2} />
            <Stop offset="100%" stopColor="#2F6560" stopOpacity={0} />
          </LinearGradient>
          <LinearGradient id="darkBand2" x1="0" y1="0" x2="1" y2="0.6">
            <Stop offset="0%" stopColor="#3E736D" stopOpacity={0} />
            <Stop offset="50%" stopColor="#3E736D" stopOpacity={0.3} />
            <Stop offset="100%" stopColor="#3E736D" stopOpacity={0} />
          </LinearGradient>
