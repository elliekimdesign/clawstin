...
/**
 * "butter_os" background art — the approved swoosh geometry recolored
 * to a bright butter-yellow field with a deep honey ribbon. A bright field
 * crossed by huge soft curved ribbons, like the classic OS update screen
 * artwork. Composition rules: every band FLOWS THROUGH the screen —
      ...
      <Svg width="100%" height="100%" viewBox="0 0 390 844" preserveAspectRatio="xMidYMid slice">
        <Defs>
          ...
          <LinearGradient id="base" x1="0" y1="0" x2="0.4" y2="1">
            <Stop offset="0%" stopColor="#C9AC5F" />
            <Stop offset="55%" stopColor="#D8C382" />
            <Stop offset="100%" stopColor="#EFE4B4" />
          </LinearGradient>

          {/* dark ribbon: strongest in its heart, melting at both rims */}
          <LinearGradient id="darkBand" x1="0" y1="0" x2="0.5" y2="1">
            <Stop offset="0%" stopColor="#8A6C2A" stopOpacity={0.5} />
            <Stop offset="60%" stopColor="#8A6C2A" stopOpacity={0.2} />
            <Stop offset="100%" stopColor="#8A6C2A" stopOpacity={0} />
          </LinearGradient>
          <LinearGradient id="darkBand2" x1="0" y1="0" x2="1" y2="0.6">
            <Stop offset="0%" stopColor="#9A7F3D" stopOpacity={0} />
            <Stop offset="50%" stopColor="#9A7F3D" stopOpacity={0.3} />
            <Stop offset="100%" stopColor="#9A7F3D" stopOpacity={0} />
          </LinearGradient>
